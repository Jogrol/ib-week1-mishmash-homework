...
// Not succeeded in removing the empty objects when a certain age category is not added. Other funcationality should work.
// A filter should be placed before the reduce function. IF person === "empty" then do nothing ELSE continue with reduce. Can't give this functionality in given time.)
